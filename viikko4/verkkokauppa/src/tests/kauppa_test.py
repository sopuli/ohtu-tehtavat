...
class TestKauppa(unittest.TestCase):
    ...
    def test_ostos_kahdella_samalla_tuotteella(self):
        ...
        self.pankki_mock.tilisiirto.assert_called_with("pekka", ANY, "12345", "33333-44455", 1)

    def test_ostoskori_on_aluksi_tyhja(self):
    ...
    def test_viitteet_toimivat(self):
